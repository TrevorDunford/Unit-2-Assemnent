...
let copiedempOne = {...empOne};
let Nick = copiedempOne
console.log(Nick)
//not sure how to change the name to nick in the console
...
let manager = new manager('Winston', 'weekday mornings, weekday afternoons', 'Cece and Schmitd')
